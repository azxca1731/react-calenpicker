...
<p>
  <img src="./examples/recipe-schedule.gif" width="300px">
  <img src="./examples/recipe-1input.gif" width="300px"/>  
  <img src="./examples/recipe-2input.gif" width="300px"/> 
</p>
...
| `customElements`          | 만약 duplicate옵션이 켜져있을시 모달이 보일때 왼쪽에 이 커스텀 엘리먼트를 렌더링 합니다                                                                                                                                                     | React.Element                                                           | `<Calendar addText duplicate customElements={<div>이렇게 넣을 수 있습니다.</div>} />`                                                                                      | `<div></div>` |
